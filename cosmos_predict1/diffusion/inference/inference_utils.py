...
def add_common_arguments(parser):
    ...
    parser.add_argument("--num_steps", type=int, default=15, help="Number of diffusion sampling steps")
    parser.add_argument("--guidance", type=float, default=0, help="Guidance scale value")
    parser.add_argument(
        "--num_video_frames",
        type=int,
        default=57,
